            ...
            <div className="space-y-4">
              {recentNews.map((n) => (
                ...
                >
                  <div className="flex">
                    {/* Color bar */}
                    <div className={`w-2 ${pillarColor[n.color]}`}></div>

                    {/* Content */}
                    <div className="flex-1 p-6">
                      <div className="flex items-start justify-between gap-4 mb-3">
                        <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-bold ${pillarColor[n.color]}`}>
                          {n.tag}
                        </span>
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <div className="flex h-14 w-14 shrink-0 flex-col items-center justify-center rounded bg-white border-2 border-dash-red">
                        <span className="text-xl font-bold text-gray-900 leading-none">{e.day}</span>
            ...
            {featuredPubs.map((pub) => (
              ...
              >
                <div className="flex items-start gap-3 mb-4">
                  <div className={`flex h-12 w-12 shrink-0 items-center justify-center rounded ${pillarColor[pub.pillar]}`}>
